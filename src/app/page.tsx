...
export default function Home() {
  ...
  {[
    ...
    <div key={idx} className="flex flex-col items-center p-4 relative">
      <div className="text-[100px] font-extrabold text-gray-200">{item.letter}</div>
      <h3 className="text-xl font-semibold text-gray-800 mt-[-40px]">{item.title}</h3>
      <p className="text-gray-500 text-xs mt-2">{item.catch}</p>
    </div>
  ))}
</div>
