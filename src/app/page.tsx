...
<section className="py-20 bg-white">
  ...
  私たちは、マーケティングやAI、デジタルの力を駆使して、
  多様な業界の課題に寄り添い、その本質を一緒に探りながら
  最適な答えを見つけ出していきます。
  解決するだけにとどまらず、お客様と共に戦略を描き、
  持続的な成長や新しい価値を共に生み出していくことが私たちの使命です。
  変化の速い時代だからこそ、柔軟な発想と挑戦する姿勢を大切に、
  未来へ続くパートナーシップを築きながら、次のステージを共に目指します。
</p>
...
<section className="py-20 bg-white border-t border-gray-200">
  ...
  逆算型のAI戦略ツールです。<br/><br/>
  ユーザーごとにカスタマイズされたAIが、保存率やいいね率を分析し、<br/>
  強みを明確化。
  <br/>PDCAを効率よく回しながら、次に打つべき施策を提案します。<br/><br/>
...
<div>
  ...
  <p className="text-gray-700 leading-relaxed mb-6">
    私たちは「MOGCIA COFFEE」というブランド名で<br />
    高品質かつ希少な豆を使用したドリップコーヒーを自社展開してきました
    <br /><br />
    SNSを駆使したマーケティングで多くの実験を行い <br />
    フォロワー数と購買率は必ずしも比例しないという <br />
    小売業のリアルを徹底的に分析。
     <br /><br />
    そこで見つけた"勝ち筋"を活かし<br />ブランディングと導線設計を緻密に構築しました。
    <br /><br />
...
<section className="py-20 bg-white">
  <div className="max-w-3xl mx-auto px-4 text-center">
    ...
    私はこれまで、ITや通信分野を中心に
  多くの法人・個人のお客様と<br />関わりながら、課題解決に取り組んできました。<br /><br />
  業務フローの改善やデジタル戦略の提案を行う中で、<br />
  もっとAIを活かして、企業の課題解決に深く寄与できないかと考えるようになりました。<br /><br />

  特に多くの企業が抱える小売や現場レベルでの課題に興味を持ち、<br />
  自身もあえて小売業に飛び込むことで、そのリアルを肌で感じ、<br />
  どうすればもっと効率化やブランド構築に役立てるのかを追求してきました。<br /><br />

  そうした経験から、ITを活用した業務改善や、
  SNSを駆使したマーケティング施策、<br />
  データ分析を通じてAIを日々の経営判断に取り入れる支援など、<br />
  多角的なサービスを提供する今の形へと繋がっています。<br /><br />

  これからも、変化を恐れず、柔軟に挑戦を続けながら、
   ビジネスを支える確かな仕組みづくりと、
  日々のちょっとした楽しみや豊かさも<br />提供していける存在でありたいと願っています。
      </p>
...
<footer className="border-t border-[#000000] bg-white text-black py-12">
  <div className="max-w-6xl mx-auto px-4 space-y-4 text-center md:text-left">
    <div className="text-sm leading-relaxed">
      <p>MOGCIA株式会社 ｜ 東京都港区〇〇ビル5F  ｜ 設立2023年</p>
      <p>事業内容：AI・デジタルソリューション、SNSマーケティング、OEM企画 等</p>
    </div>
    <div className="text-sm mt-4">&copy; 2025 MOGCIA Inc. All rights reserved.</div>
  </div>
</footer>
